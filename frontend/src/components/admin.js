                ...
                {companies.map((company) => (
                    <div key={company.id}>
                        <div className='element'>
                            ...
                            <button className='b1' onClick={() => viewTickets(company.id)}>Tickets</button>
                            <button className="b1" onClick={() => Managers(company.id)}>Managers</button>
                            <button className='b1' onClick={() => updateCompany(company.id)}>Update</button>
                            <button className='b1' onClick={() => delCompany(company.id)}>Delete</button>
                        </div>
                    </div>
                ))}
            </div>
